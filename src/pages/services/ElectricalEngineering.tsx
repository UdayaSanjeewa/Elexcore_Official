        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 rounded-3xl p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-4xl font-bold mb-4 text-white">Need Electrical Engineering Services?</h3>
              <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
                Our certified electrical engineers are ready to help with your project, big or small
              </p>
